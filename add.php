			...
			<div class="row">
				<div class="contact-caption clearfix">
					<div class="contact-heading text-center"><br><br>
						<h2 style="font-size:50px;">Add Docter</h2><br><br>
					</div>
					<div class="col-md-5 contact-info text-left">
						...
						<div class="info-detail"><br><br><br>
							...
							<a href="index.php"><img src="img/thee.JPG" alt="" class="img-responsive logo"></a>
						</div>
					</div>
					<div class="col-md-4 col-md-offset-2 contact-form">
						...
						<form method="post" action=""><br><br>
							...
							<input class="password" type="text" name="adder" placeholder=" Enter the Address"><br><br>
								 <select name="spec">
	  <option value="">Specfication</option>
	     <option value="Statins">Statins</option>
	 	 <option value="Aspirin">Aspirin</option>
		 <option value=" Clopidogrel bisulfate">Clopidogrel bisulfate</option>
	 	 ...
	 	 <option value=" Beta-blockers">Beta-blockers</option>
							...
							<br><br><br>
								...
								<input class="name" type="uname" name="uname" placeholder=" Enter the uname"><br><br>
							<input class="password" type="password" name="pwd" placeholder=" Enter the pass"><br><br>
...
<?php
$con=mysqli_connect("localhost","root","","docter");
if(isset($_REQUEST['submit']))
{
	
	$ins="insert into docters(`name`,`email`,`mob`,`adder`,`spec`,`uname`,`pwd`)
	values('".$_REQUEST['name']."','".$_REQUEST['email']."','".$_REQUEST['mob']."','".$_REQUEST['adder']."','".$_REQUEST['spec']."','".$_REQUEST['uname']."','".$_REQUEST['pwd']."')";
