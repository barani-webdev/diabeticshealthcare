					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
						     	 <li><a class="menu" href="vm1.php">Medicine Report </li>
					       	 <li><a class="menu" href="vd1.php"> Report</li>
  ...
  <tr style="background-color:olive;color:white;">
	...
	<td width="75" align="center"><b>Date</b></td>
	    ...
	    <td width="94" align="center"><b>Medicine</b></td>
		     <td width="94" align="center"><b>survey</b></td>
   </tr>
  <?php
  include ('db.php');
     $id1 =  $_POST['pid'];
  $sel="select * from med1 where pid = $id1";
