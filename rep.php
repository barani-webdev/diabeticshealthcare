			...
			<div class="row">
				<div class="contact-caption clearfix">
					<div class="contact-heading text-center"><br><br>
						<h2 style="font-size:50px;">Report</h2><br><br>
					</div>
					<div class="col-md-5 contact-info text-left">
						...
						<div class="info-detail"><br><br>
							...
							<a href="index.php"><img src="img/download.JPG" alt="" class="img-responsive logo" style="width:350px;height:350px;"></a>
						</div>
					</div>
...
<?php } ?>  
							...
							<input class="name" type="date" name="date" placeholder=" Enter the date"><br><br>
								<input class="name" type="text" name="urn" placeholder=" Enter the urine"><br><br>
							<input class="name" type="text" name="bb" placeholder=" Enter the BB"><br><br>
							<input class="password" type="text" name="suger" placeholder=" Enter the Sugar "><br><br>
							<input class="name" type="text" name="ecg" placeholder=" Enter the Ecg"><br><br>
								<input class="name" type="text" name="urn" placeholder=" Enter the urine"><br><br>
							<input class="password" type="text" name="qls" placeholder=" Enter the cholesterol "><br><br>
							<input class="name" type="text" name="exra" placeholder=" Enter the x ray"><br><br>	
...
if(isset($_REQUEST['submit']))
{
	 ...
	 $ins="insert into rep(`pid`,`pn`,`dn`,`date`,`bb`,`suger`,`ecg`,`urn`,`qls`,`exra`)
	values('".$_REQUEST['pid']."','".$_REQUEST['pn']."','".$_REQUEST['dn']."','".$_REQUEST['date']."','".$_REQUEST['bb']."','".$_REQUEST['suger']."','".$_REQUEST['ecg']."','".$_REQUEST['urn']."','".$_REQUEST['qls']."','".$_REQUEST['exra']."')";
