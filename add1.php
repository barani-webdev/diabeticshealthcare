					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        ...
					        <li><a class="menu" href="reg1.php">Add patiend</a></li>
					        <li><a class="menu" href="add1.php">Add Nurse </a></li>
							   <li><a class="menu active" href="vh.php">View Medicne </a></li>
			...
			<div class="row">
				<div class="contact-caption clearfix">
					<div class="contact-heading text-center"><br><br>
						<h2 style="font-size:50px;">Add Nurse</h2><br><br>
					</div>
					...
					<div class="col-md-4 col-md-offset-2 contact-form">
						...
						<form method="post" action=""><br><br>
							...
							<input class="password" type="text" name="pwd" placeholder=" Enter the Password "><br><br>
...
if(isset($_REQUEST['submit']))
{
	...
	$ins="insert into nurse(`name`,`email`,`mob`,`adder`,`uname`,`pwd`)
	values('".$_REQUEST['name']."','".$_REQUEST['email']."','".$_REQUEST['mob']."','".$_REQUEST['adder']."','".$_REQUEST['uname']."','".$_REQUEST['pwd']."')";
