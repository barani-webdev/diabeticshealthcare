					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        ...
					        <li><a class="menu" href="add.php">Add docter</a></li>
					        <li><a class="menu active" href="add1.php">Add Nurse </a></li>
					        <li><a class="menu" href="view1.php">Patient</a></li>
					        <li><a class="menu" href="med.php">Medicine</li>
							       <li><a class="menu" href="rep.php">report</li>
				...
				<div class="contact-caption clearfix">
					...
					<div class="col-md-4 col-md-offset-2 contact-form">
						...
						<form method="post" action=""><br><br>
							...
							<input class="password" type="text" name="price" placeholder=" Enter the price "><br><br>
							<input class="name" type="text" name="qty" placeholder=" Enter the Quantity"><br><br>
...
if(isset($_REQUEST['submit']))
{
	...
	$ins="insert into med(`name`,`price`,`qty`)
	values('".$_REQUEST['name']."','".$_REQUEST['price']."','".$_REQUEST['qty']."')";
	mysqli_query($con,$ins);
echo "<script type='text/javascript'>alert('Added successfully');</script>";
echo "<meta http-equiv='refresh' content='0;url=med.php'>";
}
?>
