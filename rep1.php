					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					       	 <li><a class="menu" href="lab.php">Medicine Report</li>
...
<br><br><br><br><br>
  ...
  { ?>
      <table width="96%" border="1" style="margin-left:20px; border:#666666 1px solid;">
  <tr >
    <td width="69" height="32" align="center"><b> DocterName</b></td>
	<td width="75" align="center"><b>Date</b></td>
        <td width="75" align="center"><b>Medicine</b></td>
	    <td width="94" align="center"><b>Medicine</b></td>
		 
   </tr>
  <?php
  include ('db.php');
     $id1 =  $_POST['pid'];
  $sel="select * from med1 where id = $id1";
  ...
  <tr>
	...
	<td align="center"><?php echo $res->medi;?></td>
	<td align="center"><?php echo $res->med;?></td>
