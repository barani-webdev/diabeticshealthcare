					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					     ...
					     <li><a class="menu" href="doc.php">Docter</a></li>
						  <li><a class="menu" href="nu1.php">Patient</a></li>
					      </ul>
					    </div><!-- /navbar-collapse -->
					  </div><!-- / .container-fluid -->
					</nav>
			...
			<div class="row">
				<div class="contact-caption clearfix">
					<div class="contact-heading text-center"><br><br>
						<h2 style="font-size:50px;">Patient Login</h2><br><br>
...
$names=$_REQUEST['name'];
$pass=$_REQUEST['pwd'];
 echo $sel="select * from `register` where  uname='$names' AND  upass='$pass'";
...
echo "<script type='text/javascript'>alert('Patient successfully');</script>";
echo "<meta http-equiv='refresh' content='0;url=vm1.php'>";
}else
{
