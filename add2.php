					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
							 ...
							 <li><a class="menu" href="medicine.php">View Report</li>
					...
					<div class="col-md-4 col-md-offset-2 contact-form">
						...
						<form method="post" action=""><br><br>
							...
							<input class="password" type="text" name="bg" placeholder=" Enter the Blood Group"><br><br>
								<input class="password" type="text" name="gender" placeholder=" Enter the Gender">
...
if(isset($_REQUEST['submit']))
{
 ...
 $ins="insert into register(`name`,`email`,`mob`,`adder`,`ages`,`bloodgroup`,`gender`,`uname`,`upass`)
	values('".$_REQUEST['name']."','".$_REQUEST['email']."','".$_REQUEST['mob']."','".$_REQUEST['adder']."','".$_REQUEST['age']."','".$_REQUEST['bg']."','".$_REQUEST['gender']."','".$_REQUEST['uname']."','".$_REQUEST['pwd']."')";
	mysqli_query($con,$ins);
echo "<script type='text/javascript'>alert('Added successfully');</script>";
echo "<meta http-equiv='refresh' content='0;url=add2.php'>";
}
?>
